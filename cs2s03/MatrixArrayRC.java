...
public class MatrixArrayRC {
	...
	MatrixArrayRC(final long[] array, int n) throws WrongLenN {
		mat = new long[n][n];
		int len = array.length;
	...
	MatrixArrayRC id(int n) throws WrongLenN {
		int size = n * n;
	...
	MatrixArrayRC matrixpower(int i) throws WrongLength, WrongLenN, WrongPower {
